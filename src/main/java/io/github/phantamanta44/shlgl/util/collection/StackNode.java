package io.github.phantamanta44.shlgl.util.collection;
...
public class StackNode<T> {
    ...
    /**
     * Checks if this stack node has a value.
     * @return Whether this node has a value or not.
     */
    ...
    /**
     * Creates a new child node of this stack node with no value.
     * @return The newly-created child node.
     */
